...
18. を追加します。**Send a message** 休日のリストを含むノード。
    ...
    ![A screenshot of a calendar Description automatically generated](./media/image25.png)

19. **Saveを**クリックしてアクションを保存します。

    ![A screenshot of a computer Description automatically generated](./media/image26.png)

    ![A screenshot of a chat box Description automatically generated](./media/image27.png)
...
5.  発行ステータスが画面に表示されます。
    ...
    [注】注：パブリッシュは迅速に完了する必要があります。Microsoft Admin Centerで実際に利用できるようになるまで、最大4時間かかることがあります。

6.  管理者は、Microsoft Admin
    Centerの**\[設定\]**、\[**統合\]の**順に表示される**DataverseとMicrosoft
    Copilot Studio**統合アプリを**確認し、承認します**。

    [注意] 重要です：管理者が管理センターに表示するには、有効なCopilotライセンスを保有している必要があります。
